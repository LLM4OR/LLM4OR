...
- LLMOPT: Learning to Define and Solve General Optimization Problems from Scratch, *Jiang et al.* 
...
- Evo-Step: Evolutionary Generation and Stepwise Validation for Optimizing LLMs in OR, *Wu et al.* 
...
- Towards Foundation Models for Mixed Integer Linear Programming, *Li et al.*
...
### Inference
- Leveraging Large Language Models for Solving Rare MIP Challenges, *Wang et al.* 
    - <a href="https://arxiv.org/abs/2409.04464"><img src="https://img.shields.io/badge/arXiv-Paper-B31B1B.svg"></a>
- To the Globe (TTG): Towards Language-Driven Guaranteed Travel Planning, *Ju et al.* 
    - <a href="https://arxiv.org/abs/2409.04464"><img src="https://img.shields.io/badge/arXiv-Paper-B31B1B.svg"></a>
- OptiChat: Bridging Optimization Models and Practitioners with Large Language Models, *Chen et al.* 
...
- City-LEO: Toward Transparent City Management Using LLM with End-to-End Optimization, *Jiao et al.* 
    - <a href="https://arxiv.org/abs/2406.10958"><img src="https://img.shields.io/badge/arXiv-Paper-B31B1B.svg"></a>
- LLM-based Frameworks for Power Engineering from Routine to Novel Tasks, *Li et al.* 
...
- Navigate through Enigmatic Labyrinth A Survey of Chain of Thought Reasoning: Advances, Frontiers and Future, *Chu et al.* 
...
- CAFA: Coding as Auto-Formulation Can Boost Large Language Models in Solving Linear Programming Problem, *Deng et al.* 
...
- Autoformulation of Mathematical Optimization Models Using LLMs, *Astorga et al.* 
    - <a href="https://arxiv.org/abs/2411.01679"><img src="https://img.shields.io/badge/arXiv-Paper-B31B1B.svg"></a> 
- Scaling Large-Language-Model-based Multi-Agent Collaboration, *Qian et al.* 
...
- OptiGuide: Large Language Models for Supply Chain Optimization, *Li et al.* 
...
- Solving General Natural-Language-Description Optimization Problems with Large Language Models, *Zhang et al.* 
    - <a href="https://arxiv.org/abs/2407.07924"><img src="https://img.shields.io/badge/arXiv-Paper-B31B1B.svg"></a>
- Decision Information Meets Large Language Models: The Future of Explainable Operations Research, *Zhang et al.* 
...
- OptiBench Meets ReSocratic: Measure and Improve LLMs for Optimization Modeling, *Yang et al.*
    - <a href="https://arxiv.org/abs/2407.09887"><img src="https://img.shields.io/badge/arXiv-Paper-B31B1B.svg"></a> <a href="https://github.com/yangzhch6/ReSocratic"><img src="https://img.shields.io/github/stars/yangzhch6/ReSocratic?style=social"></a>
- WIQOR: A dataset for what-if analysis of Operations Research problems, *Parashar et al.* 
    - <a href="https://openreview.net/forum?id=no8ysO3xde"><img src="https://img.shields.io/badge/OpenReview-Paper-red"></a> 

### Evaluation
- Towards Human-aligned Evaluation for Linear Programming Word Problems, *Xing et al.* 
    - <a href="https://openreview.net/forum?id=AgJXabVaHo"><img src="https://img.shields.io/badge/OpenReview-Paper-red"></a>
- OptiBench: Benchmarking Large Language Models in Optimization Modeling with Equivalence-Detection Evaluation, *Wang et al.* 
